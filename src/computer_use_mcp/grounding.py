...
class GroundingRouter:
    ...
    3. Coordinate default / trivial grounding — non-spatial actions (type, keypress,
       scroll, wait, done) without a target are grounded trivially with strategy ``"none"``;
       anything else that no strategy can ground raises :class:`UnsupportedGroundingError`
       (fail-closed).
    """
