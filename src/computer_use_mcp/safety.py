...
class SafetyPolicy:
    ...
    def evaluate(
        ...
        *,
        ...
        if action.action == ActionType.KEYPRESS and any(
        ...
        elif action.action in {ActionType.CLICK, ActionType.DOUBLE_CLICK, ActionType.DRAG, ActionType.TYPE}:
    ...
    def classify(
        ...
        if action.action in {ActionType.SCROLL, ActionType.WAIT, ActionType.DONE}:
            return RiskLevel.LOW, "low_routine_action", self._why("low_routine_action")
